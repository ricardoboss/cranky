...
public static class OutputExtensions
{
    ...
    public static void WriteInfoEscaped(this IOutput output, string message, string? file = null, int? line = null, int? col = null, int? endLine = null, int? endColumn = null, string? code = null)
    {
        if (output is AnsiConsoleOutput)
            message = message.EscapeMarkup();

        output.WriteInfo(message, file, line, col, endLine, endColumn, code);
    }
